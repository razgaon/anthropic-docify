...
3. Accuracy: Are the provided instructions, examples, and other technical details accurate? Are there discrepancies between new proposed documentation specified in <improved_page> and the official Langchain documentation specified in <reference_page>?
...
In particular, please carefully review the <improved_page> and see if there are any content that seems to be made up and cannot be found in context or reference page.
